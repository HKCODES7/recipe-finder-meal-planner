...
const RecipeCard = class {
    constructor(hostRef) {
        ...
        this.favoriteToggled = createEvent(this, "favoriteToggled");
        this.detailsRequested = createEvent(this, "detailsRequested");
        this.deleteRequested = createEvent(this, "deleteRequested");
        this.imageUrl = '';
        this.category = '';
